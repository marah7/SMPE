...
##  Here also not a very good explanation(if your audience is not familiar with this kind of output). It is a little complex.
...
## Why are we doing this if there is no impact between temp and malfunction? , after the lecture, I got the answer, we should make it by numbers not just visualizing.
```{r}
